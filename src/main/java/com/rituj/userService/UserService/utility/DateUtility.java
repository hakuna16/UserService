...
public class DateUtility {
	...
	/**
	 * Converts the given string date representation to {@link LocalDate}. 
	 * Uses {@link StoreCentralRangeHubConstants#OUTPUT_DATE_FORMAT} as the date
	 * format while parsing the date.
	 *
	 * @param date string representation of date to be parsed.
	 * @return {@link LocalDate} object of the given string date.
	 * @throws IllegalArgumentException if date is empty or null.
	 */
	...
	/**
	 * Get system date as string in the format {@link DateTimeFormatter#ISO_OFFSET_DATE_TIME}.
	 * Gets the current date & time from {@link ZonedDateTime#now} and formats in {@link DateTimeFormatter#ISO_OFFSET_DATE_TIME}.
	 * 
